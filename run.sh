#!/bin/bash
#SBATCH --job-name=cd_cw_N2_qd                    # Job name
#SBATCH --output=outputs/cd_cw_N2_qd_%j.log        # Standard output log (%j = job ID)
#SBATCH --error=outputs/cd_cw_N2_qd_%j.err         # Standard error log
